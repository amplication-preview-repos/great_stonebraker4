...
export class BookingResolverBase {
  ...
  async createBooking(
    ...
    return await this.service.createBooking({
      ...
      data: {
        ...
        dog: args.data.dog
          ? {
              connect: args.data.dog,
            }
          : undefined,

        dogSitter: args.data.dogSitter
          ? {
              connect: args.data.dogSitter,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => Dog, {
    nullable: true,
    name: "dog",
  })
  async getDog(@graphql.Parent() parent: Booking): Promise<Dog | null> {
    const result = await this.service.getDog(parent.id);
  ...
  async getDogSitter(
    ...
    const result = await this.service.getDogSitter(parent.id);
