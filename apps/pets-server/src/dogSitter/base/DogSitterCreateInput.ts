...
class DogSitterCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ReviewCreateNestedManyWithoutDogSittersInput,
  })
  @ValidateNested()
  @Type(() => ReviewCreateNestedManyWithoutDogSittersInput)
  @IsOptional()
  @Field(() => ReviewCreateNestedManyWithoutDogSittersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => BookingCreateNestedManyWithoutDogSittersInput,
  })
  @ValidateNested()
  @Type(() => BookingCreateNestedManyWithoutDogSittersInput)
  @IsOptional()
  @Field(() => BookingCreateNestedManyWithoutDogSittersInput, {
    nullable: true,
  })
  bookings?: BookingCreateNestedManyWithoutDogSittersInput;
}

export { DogSitterCreateInput as DogSitterCreateInput };
